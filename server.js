...
var corsOptions = {
  origin: ["https://library-application-backend.onrender.com", "https://comp229library.netlify.app"],
  credentials: true,
...
app.get('/private', function(req, res) {
  res.set('Access-Control-Allow-Origin', 'https://comp229library.netlify.app')
